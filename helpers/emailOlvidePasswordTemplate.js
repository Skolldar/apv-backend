...
const emailOlvidePassword = ({ nombre, token, frontendUrl }) => `
  <style>
  ...
  <div class="email-wrapper" style="background: url('https://i.postimg.cc/BZPG1895/retrato-grupo-cinco-adorables-cachorros.png') center/cover no-repeat; background-color:#ffffff;">
    ...
    <div class="email-container" style="backdrop-filter: blur(12px);background: rgba(255,255,255,0.7);max-width:480px;margin:0 auto;border-radius:18px;box-shadow:0 2px 16px rgba(0,0,0,0.12);padding:40px 32px;text-align:center;color:#111;font-family:'Poppins',Arial,sans-serif;">
      ...
      <p class="email-text" style="font-size:18px;color:#111;margin-bottom:24px;">Hola, <strong>${nombre}</strong>!<br>Has solicitado Reestablecer tu Contraseña.</p>
      <p class="email-text" style="font-size:16px;color:#111;margin-bottom:32px;">Sigue el siguiente enlace para generar una nueva contraseña: </p>
        <a class="email-cta" href="${frontendUrl}/olvide-password/${token}">Reestablecer Contraseña</a>
      <p style="font-size:13px;color:#222;margin-top:32px;">Si no solicitaste este cambio, puedes ignorar este mensaje.</p>
    </div>
  </div>
`;
